...
@interface MKCLServerForDeviceModel ()
...
@implementation MKCLServerForDeviceModel
...
- (void)updateValue:(MKCLServerForDeviceModel *)model {
    if (!model || ![model isKindOfClass:MKCLServerForDeviceModel.class]) {
        return;
    }
...
- (BOOL)readDeviceMac {
    ...
    [MKCLInterface cl_readDeviceWifiSTAMacAddressWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readDeviceName {
    __block BOOL success = NO;
    [MKCLInterface cl_readDeviceNameWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readHost {
    __block BOOL success = NO;
    [MKCLInterface cl_readServerHostWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configHost {
    __block BOOL success = NO;
    [MKCLInterface cl_configServerHost:self.host sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readPort {
    __block BOOL success = NO;
    [MKCLInterface cl_readServerPortWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configPort {
    __block BOOL success = NO;
    [MKCLInterface cl_configServerPort:[self.port integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readClientID {
    __block BOOL success = NO;
    [MKCLInterface cl_readClientIDWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configClientID {
    __block BOOL success = NO;
    [MKCLInterface cl_configClientID:self.clientID sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readUsername {
    __block BOOL success = NO;
    [MKCLInterface cl_readServerUserNameWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configUserName {
    __block BOOL success = NO;
    [MKCLInterface cl_configServerUserName:self.userName sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readPassword {
    __block BOOL success = NO;
    [MKCLInterface cl_readServerPasswordWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configPassword {
    __block BOOL success = NO;
    [MKCLInterface cl_configServerPassword:self.password sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readCleanSession {
    __block BOOL success = NO;
    [MKCLInterface cl_readServerCleanSessionWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configCleanSession {
    __block BOOL success = NO;
    [MKCLInterface cl_configServerCleanSession:self.cleanSession sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readKeepAlive {
    __block BOOL success = NO;
    [MKCLInterface cl_readServerKeepAliveWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configKeepAlive {
    __block BOOL success = NO;
    [MKCLInterface cl_configServerKeepAlive:[self.keepAlive integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readQos {
    __block BOOL success = NO;
    [MKCLInterface cl_readServerQosWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configQos {
    __block BOOL success = NO;
    [MKCLInterface cl_configServerQos:self.qos sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readSubscribe {
    __block BOOL success = NO;
    [MKCLInterface cl_readSubscibeTopicWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configSubscribe {
    ...
    [MKCLInterface cl_configSubscibeTopic:topic sucBlock:^{
        success = YES;
...
- (BOOL)readPublish {
    __block BOOL success = NO;
    [MKCLInterface cl_readPublishTopicWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configPublish {
    ...
    [MKCLInterface cl_configPublishTopic:topic sucBlock:^{
        success = YES;
...
- (BOOL)readLWTStatus {
    __block BOOL success = NO;
    [MKCLInterface cl_readLWTStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configLWTStatus {
    __block BOOL success = NO;
    [MKCLInterface cl_configLWTStatus:self.lwtStatus sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readLWTQos {
    __block BOOL success = NO;
    [MKCLInterface cl_readLWTQosWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configLWTQos {
    __block BOOL success = NO;
    [MKCLInterface cl_configLWTQos:self.lwtQos sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readLWTRetain {
    __block BOOL success = NO;
    [MKCLInterface cl_readLWTRetainWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configLWTRetain {
    __block BOOL success = NO;
    [MKCLInterface cl_configLWTRetain:self.lwtRetain sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readLWTTopic {
    __block BOOL success = NO;
    [MKCLInterface cl_readLWTTopicWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configLWTTopic {
    ...
    [MKCLInterface cl_configLWTTopic:topic sucBlock:^{
        success = YES;
        self.lwtTopic = topic;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
...
- (BOOL)readLWTPayload {
    __block BOOL success = NO;
    [MKCLInterface cl_readLWTPayloadWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configLWTPayload {
    __block BOOL success = NO;
    [MKCLInterface cl_configLWTPayload:self.lwtPayload sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readSSLStatus {
    __block BOOL success = NO;
    [MKCLInterface cl_readConnectModeWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configSSLStatus {
    __block BOOL success = NO;
    mk_cl_connectMode mode = mk_cl_connectMode_TCP;
    if (self.sslIsOn) {
        if (self.certificate == 0) {
            mode = mk_cl_connectMode_CASignedServerCertificate;
        }else if (self.certificate == 1) {
            mode = mk_cl_connectMode_CACertificate;
        }else if (self.certificate == 2) {
            mode = mk_cl_connectMode_SelfSignedCertificates;
        }
    }
    [MKCLInterface cl_configConnectMode:mode sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configCAFile {
    ...
    [MKCLInterface cl_configCAFile:caData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configClientKey {
    ...
    [MKCLInterface cl_configClientPrivateKey:clientKeyData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)configClientCert {
    ...
    [MKCLInterface cl_configClientCert:clientCertData sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
