//
//  MKCLBleWifiSettingsController.m
...
@interface MKCLBleWifiSettingsController ()<UITableViewDelegate,
UITableViewDataSource,
MKTextFieldCellDelegate,
mk_textSwitchCellDelegate,
MKCLBleWifiSettingsBandCellDelegate>
...
@property (nonatomic, strong)MKCLBleWifiSettingsModel *dataModel;

@end

@implementation MKCLBleWifiSettingsController

- (void)dealloc {
    NSLog(@"MKCLBleWifiSettingsController销毁");
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 1) {
        MKCLBleWifiSettingsBandCell *cell = [MKCLBleWifiSettingsBandCell initCellWithTableView:self.tableView];
...
- (void)cl_bleWifiSettingsBandCell_countryChanged:(NSInteger)country {
    ...
    MKCLBleWifiSettingsBandCellModel *cellModel = self.section1List[0];
...
- (void)saveDataToDevice {
    ...
    [self.dataModel configDataWithSucBlock:^{
        ...
        [MKCLDeviceMQTTParamsModel shared].wifiConfig = YES;
    } failedBlock:^(NSError * _Nonnull error) {
        @strongify(self);
        [[MKHudManager share] hide];
        [self.view showCentralToast:error.userInfo[@"errorInfo"]];
        [MKCLDeviceMQTTParamsModel shared].wifiConfig = NO;
    }];
}
...
- (void)loadSection1Datas {
    MKCLBleWifiSettingsBandCellModel *cellModel = [[MKCLBleWifiSettingsBandCellModel alloc] init];
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayMiniThree", @"MKCLBleWifiSettingsController", @"cl_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCLBleWifiSettingsModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCLBleWifiSettingsModel alloc] init];
    }
    return _dataModel;
}
