...
@interface MKCLBleAdvBeaconModel ()
...
@implementation MKCLBleAdvBeaconModel
...
- (BOOL)readAdvStatus {
    ...
    [MKCLInterface cl_readAdvertiseBeaconStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configAdvStatus {
    __block BOOL success = NO;
    [MKCLInterface cl_configAdvertiseBeaconStatus:self.advertise sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readMajor {
    __block BOOL success = NO;
    [MKCLInterface cl_readBeaconMajorWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configMajor {
    __block BOOL success = NO;
    [MKCLInterface cl_configBeaconMajor:[self.major integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readMinor {
    __block BOOL success = NO;
    [MKCLInterface cl_readBeaconMinorWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configMinor {
    __block BOOL success = NO;
    [MKCLInterface cl_configBeaconMinor:[self.minor integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readUUID {
    __block BOOL success = NO;
    [MKCLInterface cl_readBeaconUUIDWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configUUID {
    __block BOOL success = NO;
    [MKCLInterface cl_configBeaconUUID:self.uuid sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readInterval {
    __block BOOL success = NO;
    [MKCLInterface cl_readBeaconAdvIntervalWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configInterval {
    __block BOOL success = NO;
    [MKCLInterface cl_configAdvInterval:[self.advInterval integerValue] sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
...
- (BOOL)readTxPower {
    __block BOOL success = NO;
    [MKCLInterface cl_readBeaconTxPowerWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configTxPower {
    __block BOOL success = NO;
    [MKCLInterface cl_configTxPower:self.txPower sucBlock:^{
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
