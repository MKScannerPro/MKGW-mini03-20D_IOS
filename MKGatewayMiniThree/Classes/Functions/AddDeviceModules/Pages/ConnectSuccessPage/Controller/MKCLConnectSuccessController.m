//
//  MKCLConnectSuccessController.m
...
@interface MKCLConnectSuccessController ()
...
@implementation MKCLConnectSuccessController

- (void)dealloc {
    NSLog(@"MKCLConnectSuccessController销毁");
}
...
- (void)saveButtonPressed {
    ...
    [MKCLDeviceDatabaseManager insertDeviceList:@[self.deviceModel] sucBlock:^{
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_cl_addNewDeviceSuccessNotification"
                                                            object:nil
