...
@interface MKCLBleDeviceInfoModel ()
...
@implementation MKCLBleDeviceInfoModel
...
- (BOOL)readDeviceModel {
    __block BOOL success = NO;
    [MKCLInterface cl_readDeviceModelWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readSoftware {
    __block BOOL success = NO;
    [MKCLInterface cl_readSoftwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readHardware {
    __block BOOL success = NO;
    [MKCLInterface cl_readHardwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readManu {
    __block BOOL success = NO;
    [MKCLInterface cl_readManufacturerWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
