...
@interface MKCLBleDeviceInfoController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKCLBleDeviceInfoModel *dataModel;

@end

@implementation MKCLBleDeviceInfoController

- (void)dealloc {
    NSLog(@"MKCLBleDeviceInfoController销毁");
...
- (MKCLBleDeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCLBleDeviceInfoModel alloc] init];
    }
    return _dataModel;
}
