//
//  MKCLUploadDataOptionController.m
...
@interface MKCLUploadDataOptionController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCLUploadDataOptionModel *dataModel;

@end

@implementation MKCLUploadDataOptionController

- (void)dealloc {
    NSLog(@"MKCLUploadDataOptionController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayMiniThree", @"MKCLUploadDataOptionController", @"cl_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCLUploadDataOptionModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCLUploadDataOptionModel alloc] init];
    }
    return _dataModel;
}
