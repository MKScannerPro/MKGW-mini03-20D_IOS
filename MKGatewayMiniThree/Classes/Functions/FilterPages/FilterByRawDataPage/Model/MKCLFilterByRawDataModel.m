...
@interface MKCLFilterByRawDataModel ()
...
@implementation MKCLFilterByRawDataModel
...
- (BOOL)readFilterByRawData {
    ...
    [MKCLMQTTInterface cl_readFilterByRawDataStatusWithMacAddress:[MKCLDeviceModeManager shared].macAddress topic:[MKCLDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
