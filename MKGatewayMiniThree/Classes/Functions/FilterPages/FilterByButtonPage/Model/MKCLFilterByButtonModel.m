...
@interface MKCLFilterByButtonModel ()
...
@implementation MKCLFilterByButtonModel
...
- (BOOL)readFilterByBXPButton {
    ...
    [MKCLMQTTInterface cl_readFilterBXPButtonWithMacAddress:[MKCLDeviceModeManager shared].macAddress topic:[MKCLDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configFilterByBXPButton {
    __block BOOL success = NO;
    [MKCLMQTTInterface cl_configFilterBXPButton:self macAddress:[MKCLDeviceModeManager shared].macAddress topic:[MKCLDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
