//
//  MKCLFilterByAdvNameController.m
...
@interface MKCLFilterByAdvNameController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCLFilterByAdvNameModel *dataModel;

@end

@implementation MKCLFilterByAdvNameController

- (void)dealloc {
    NSLog(@"MKCLFilterByAdvNameController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayMiniThree", @"MKCLFilterByAdvNameController", @"cl_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCLFilterByAdvNameModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCLFilterByAdvNameModel alloc] init];
    }
    return _dataModel;
}
