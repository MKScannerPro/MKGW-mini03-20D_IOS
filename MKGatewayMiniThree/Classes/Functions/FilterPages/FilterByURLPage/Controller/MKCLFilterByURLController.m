...
@interface MKCLFilterByURLController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCLFilterByURLModel *dataModel;

@end

@implementation MKCLFilterByURLController

- (void)dealloc {
    NSLog(@"MKCLFilterByURLController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayMiniThree", @"MKCLFilterByURLController", @"cl_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCLFilterByURLModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCLFilterByURLModel alloc] init];
    }
    return _dataModel;
}
