...
@implementation MKCLFilterRawAdvDataModel
...
@interface MKCLFilterByOtherModel ()
...
@implementation MKCLFilterByOtherModel
...
- (void)configWithRawDataList:(NSArray <MKCLFilterRawAdvDataModel *>*)list
...
- (BOOL)readFilterByOther {
    ...
    [MKCLMQTTInterface cl_readFilterOtherDatasWithMacAddress:[MKCLDeviceModeManager shared].macAddress topic:[MKCLDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configFilterByOther:(NSArray <MKCLFilterRawAdvDataModel *>*)list relationship:(mk_cl_filterByOther)relationship {
    __block BOOL success = NO;
    [MKCLMQTTInterface cl_configFilterByOtherDatas:self.isOn relationship:relationship rawDataList:list macAddress:[MKCLDeviceModeManager shared].macAddress topic:[MKCLDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
