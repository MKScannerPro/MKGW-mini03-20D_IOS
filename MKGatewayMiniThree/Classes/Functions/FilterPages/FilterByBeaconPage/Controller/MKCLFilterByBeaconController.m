//
//  MKCLFilterByBeaconController.m
...
@interface MKCLFilterByBeaconController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCLFilterByBeaconModel *dataModel;

@end

@implementation MKCLFilterByBeaconController

- (void)dealloc {
    NSLog(@"MKCLFilterByBeaconController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayMiniThree", @"MKCLFilterByBeaconController", @"cl_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCLFilterByBeaconModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCLFilterByBeaconModel alloc] initWithPageType:self.pageType];
    }
    return _dataModel;
}
