...
@implementation MKCLAddDeviceView
...
- (UIImageView *)centerIcon{
    if (!_centerIcon) {
        ...
        _centerIcon.image = LOADICON(@"MKGatewayMiniThree", @"MKCLAddDeviceView", @"cl_deviceList_centerIcon.png");
    }
    return _centerIcon;
}
