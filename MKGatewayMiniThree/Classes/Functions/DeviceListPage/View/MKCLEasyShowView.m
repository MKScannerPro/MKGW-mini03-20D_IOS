...
@implementation MKCLEasyShowView
...
- (UIImageView *)refreshIcon {
    if (!_refreshIcon) {
        ...
        _refreshIcon.image = LOADICON(@"MKGatewayMiniThree", @"MKCLEasyShowView", @"cl_refreshIcon.png");
    }
    return _refreshIcon;
}
