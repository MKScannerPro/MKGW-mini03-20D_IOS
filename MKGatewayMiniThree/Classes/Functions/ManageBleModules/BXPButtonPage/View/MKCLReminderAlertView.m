...
@implementation MKCLReminderAlertViewModel
@end

@interface MKCLReminderColorButton : UIControl
...
@implementation MKCLReminderColorButton
...
- (UIImageView *)icon {
    if (!_icon) {
        ...
        _icon.image = LOADICON(@"MKGatewayMiniThree", @"MKCLReminderColorButton", @"cl_resetByButtonUnselectedIcon.png");
    }
    return _icon;
}
...
@interface MKCLReminderAlertView ()
...
@property (nonatomic, strong)MKCLReminderColorButton *redColor;

@property (nonatomic, strong)MKCLReminderColorButton *blueColor;

@property (nonatomic, strong)MKCLReminderColorButton *greenColor;

@end

@implementation MKCLReminderAlertView
...
- (void)setupColorIcons {
    self.redColor.icon.image = (self.currentColor == 0 ? LOADICON(@"MKGatewayMiniThree", @"MKCLReminderColorButton", @"cl_resetByButtonSelectedIcon.png") : LOADICON(@"MKGatewayMiniThree", @"MKCLReminderColorButton", @"cl_resetByButtonUnselectedIcon.png"));
    self.blueColor.icon.image = (self.currentColor == 1 ? LOADICON(@"MKGatewayMiniThree", @"MKCLReminderColorButton", @"cl_resetByButtonSelectedIcon.png") : LOADICON(@"MKGatewayMiniThree", @"MKCLReminderColorButton", @"cl_resetByButtonUnselectedIcon.png"));
    self.greenColor.icon.image = (self.currentColor == 2 ? LOADICON(@"MKGatewayMiniThree", @"MKCLReminderColorButton", @"cl_resetByButtonSelectedIcon.png") : LOADICON(@"MKGatewayMiniThree", @"MKCLReminderColorButton", @"cl_resetByButtonUnselectedIcon.png"));
}
...
- (MKCLReminderColorButton *)redColor {
    if (!_redColor) {
        _redColor = [[MKCLReminderColorButton alloc] init];
...
- (MKCLReminderColorButton *)blueColor {
    if (!_blueColor) {
        _blueColor = [[MKCLReminderColorButton alloc] init];
...
- (MKCLReminderColorButton *)greenColor {
    if (!_greenColor) {
        _greenColor = [[MKCLReminderColorButton alloc] init];
