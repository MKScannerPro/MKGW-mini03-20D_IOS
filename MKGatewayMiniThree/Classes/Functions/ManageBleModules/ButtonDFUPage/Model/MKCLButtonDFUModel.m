...
@implementation MKCLButtonDFUModel
...
- (BOOL)startDfu {
    ...
    [MKCLMQTTInterface cl_startBXPButtonDfuWithFirmwareUrl:self.firmwareUrl dataUrl:self.dataUrl bleMac:self.bleMac macAddress:[MKCLDeviceModeManager shared].macAddress topic:[MKCLDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
