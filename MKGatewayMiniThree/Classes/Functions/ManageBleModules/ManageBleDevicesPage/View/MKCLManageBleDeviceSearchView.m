//
//  MKCLManageBleDeviceSearchView.m
...
@interface MKCLManageBleDeviceSearchView ()<UIGestureRecognizerDelegate>
...
@implementation MKCLManageBleDeviceSearchView

- (void)dealloc{
    NSLog(@"MKCLManageBleDeviceSearchView销毁");
}
...
+ (void)showSearchName:(NSString *)name
    ...
    MKCLManageBleDeviceSearchView *view = [[MKCLManageBleDeviceSearchView alloc] init];
...
- (UIImageView *)signalIcon{
    if (!_signalIcon) {
        _signalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(offset_X,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _signalIcon.image = LOADICON(@"MKGatewayMiniThree", @"MKCLManageBleDeviceSearchView", @"cl_wifiSignalIcon.png");
    }
    return _signalIcon;
}
...
- (UIImageView *)graySignalIcon {
    if (!_graySignalIcon) {
        _graySignalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(backViewWidth - offset_X - signalIconWidth,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _graySignalIcon.image = LOADICON(@"MKGatewayMiniThree", @"MKCLManageBleDeviceSearchView", @"cl_wifiGraySignalIcon.png");
    }
