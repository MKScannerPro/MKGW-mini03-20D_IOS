//
//  MKCLManageBleDevicesSearchButton.m
...
@implementation MKCLManageBleDevicesSearchButtonModel
@end

@interface MKCLManageBleDevicesSearchButton ()
...
@implementation MKCLManageBleDevicesSearchButton
...
- (void)clearButtonPressed{
    ...
    if ([self.delegate respondsToSelector:@selector(cl_scanSearchButtonClearMethod)]) {
        [self.delegate cl_scanSearchButtonClearMethod];
    }
}

- (void)searchButtonPressed{
    if ([self.delegate respondsToSelector:@selector(cl_scanSearchButtonMethod)]) {
        [self.delegate cl_scanSearchButtonMethod];
    }
}

#pragma mark - setting
- (void)setDataModel:(MKCLManageBleDevicesSearchButtonModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKCLManageBleDevicesSearchButtonModel.class]) {
        return;
    }
...
- (UIImageView *)searchIcon{
    if (!_searchIcon) {
        ...
        _searchIcon.image = LOADICON(@"MKGatewayMiniThree", @"MKCLManageBleDevicesSearchButton", @"cl_searchGrayIcon.png");
    }
    return _searchIcon;
}
...
- (UIButton *)clearButton{
    if (!_clearButton) {
        ...
        [_clearButton setImage:LOADICON(@"MKGatewayMiniThree", @"MKCLManageBleDevicesSearchButton", @"cl_clearButtonIcon.png") forState:UIControlStateNormal];
