//
//  MKCLConnectedDeviceWriteAlertView.m
...
@interface MKCLConnectedDeviceWriteAlertView ()
...
@implementation MKCLConnectedDeviceWriteAlertView

- (void)dealloc {
    NSLog(@"MKCLConnectedDeviceWriteAlertView销毁");
}
