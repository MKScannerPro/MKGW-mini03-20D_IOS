//
//  MKCLIndicatorSettingsController.m
...
@interface MKCLIndicatorSettingsController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCLIndicatorSetingsModel *dataModel;

@end

@implementation MKCLIndicatorSettingsController

- (void)dealloc {
    NSLog(@"MKCLIndicatorSettingsController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayMiniThree", @"MKCLIndicatorSettingsController", @"cl_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCLIndicatorSetingsModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCLIndicatorSetingsModel alloc] init];
    }
    return _dataModel;
}
