...
@interface MKCLIndicatorSetingsModel ()
...
@implementation MKCLIndicatorSetingsModel
...
- (BOOL)readIndicatorLightStatus {
    ...
    [MKCLMQTTInterface cl_readIndicatorLightStatusWithMacAddress:[MKCLDeviceModeManager shared].macAddress topic:[MKCLDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configIndicatorLightStatus {
    __block BOOL success = NO;
    [MKCLMQTTInterface cl_configIndicatorLightStatus:self macAddress:[MKCLDeviceModeManager shared].macAddress topic:[MKCLDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
