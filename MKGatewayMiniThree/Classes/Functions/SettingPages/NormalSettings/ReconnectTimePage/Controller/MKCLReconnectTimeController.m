...
@interface MKCLReconnectTimeController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCLReconnectTimeModel *dataModel;

@end

@implementation MKCLReconnectTimeController

- (void)dealloc {
    NSLog(@"MKCLReconnectTimeController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayMiniThree", @"MKCLReconnectTimeController", @"cl_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCLReconnectTimeModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCLReconnectTimeModel alloc] init];
    }
    return _dataModel;
}
