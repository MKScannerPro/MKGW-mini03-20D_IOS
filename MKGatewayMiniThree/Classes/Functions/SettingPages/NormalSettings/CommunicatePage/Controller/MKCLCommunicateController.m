...
@interface MKCLCommunicateController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCLCommunicateModel *dataModel;

@end

@implementation MKCLCommunicateController

- (void)dealloc {
    NSLog(@"MKCLCommunicateController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayMiniThree", @"MKCLCommunicateController", @"cl_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCLCommunicateModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCLCommunicateModel alloc] init];
    }
    return _dataModel;
}
