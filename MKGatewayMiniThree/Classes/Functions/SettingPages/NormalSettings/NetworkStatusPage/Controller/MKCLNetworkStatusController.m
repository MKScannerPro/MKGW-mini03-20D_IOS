...
@interface MKCLNetworkStatusController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCLNetworkStatusModel *dataModel;

@end

@implementation MKCLNetworkStatusController

- (void)dealloc {
    NSLog(@"MKCLNetworkStatusController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayMiniThree", @"MKCLNetworkStatusController", @"cl_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCLNetworkStatusModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCLNetworkStatusModel alloc] init];
    }
    return _dataModel;
}
