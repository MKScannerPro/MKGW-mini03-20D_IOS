...
@interface MKCLAdvBeaconParamsModel : NSObject<cl_advertiseBeaconProtocol>
...
@implementation MKCLAdvBeaconParamsModel
@end


@interface MKCLAdvBeaconModel ()
...
@implementation MKCLAdvBeaconModel
...
- (BOOL)readAdvBeaconDatas {
    ...
    [MKCLMQTTInterface cl_readAdvertiseBeaconParamsWithMacAddress:[MKCLDeviceModeManager shared].macAddress topic:[MKCLDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configAdvBeaconDatas {
    ...
    MKCLAdvBeaconParamsModel *dataModel = [[MKCLAdvBeaconParamsModel alloc] init];
    ...
    [MKCLMQTTInterface cl_configAdvertiseBeaconParams:dataModel macAddress:[MKCLDeviceModeManager shared].macAddress topic:[MKCLDeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
