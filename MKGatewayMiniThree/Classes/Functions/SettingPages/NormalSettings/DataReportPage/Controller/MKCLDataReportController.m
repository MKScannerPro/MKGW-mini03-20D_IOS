...
@interface MKCLDataReportController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCLDataReportModel *dataModel;

@end

@implementation MKCLDataReportController

- (void)dealloc {
    NSLog(@"MKCLDataReportController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayMiniThree", @"MKCLDataReportController", @"cl_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCLDataReportModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCLDataReportModel alloc] init];
    }
    return _dataModel;
}
