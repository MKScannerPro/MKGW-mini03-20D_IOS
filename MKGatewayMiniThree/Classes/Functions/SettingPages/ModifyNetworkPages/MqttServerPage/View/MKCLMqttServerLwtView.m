...
@implementation MKCLMqttServerLwtViewModel
@end

@interface MKCLMqttServerLwtView ()
...
@implementation MKCLMqttServerLwtView
...
- (void)lwtButtonPressed {
    ...
    UIImage *lwtIcon = (self.lwtButton.selected ? LOADICON(@"MKGatewayMiniThree", @"MKCLMqttServerLwtView", @"cl_switchSelectedIcon.png") : LOADICON(@"MKGatewayMiniThree", @"MKCLMqttServerLwtView", @"cl_switchUnselectedIcon.png"));
...
- (void)retainButtonPressed {
    ...
    UIImage *retainIcon = (self.retainButton.selected ? LOADICON(@"MKGatewayMiniThree", @"MKCLMqttServerLwtView", @"cl_switchSelectedIcon.png") : LOADICON(@"MKGatewayMiniThree", @"MKCLMqttServerLwtView", @"cl_switchUnselectedIcon.png"));
...
#pragma mark - setter
- (void)setDataModel:(MKCLMqttServerLwtViewModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKCLMqttServerLwtViewModel.class]) {
        return;
    }
...
- (UIButton *)lwtButton {
    if (!_lwtButton) {
        ...
        [_lwtButton setImage:LOADICON(@"MKGatewayMiniThree", @"MKCLMqttServerLwtView", @"cl_switchUnselectedIcon.png") forState:UIControlStateNormal];
...
- (UIButton *)retainButton {
    if (!_retainButton) {
        ...
        [_retainButton setImage:LOADICON(@"MKGatewayMiniThree", @"MKCLMqttServerLwtView", @"cl_switchUnselectedIcon.png") forState:UIControlStateNormal];
