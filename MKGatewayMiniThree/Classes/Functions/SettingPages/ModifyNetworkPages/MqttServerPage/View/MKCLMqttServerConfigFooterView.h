//
//  MKCLMqttServerConfigFooterView.h
...
@interface MKCLMqttServerConfigFooterViewModel : NSObject
...
@protocol MKCLMqttServerConfigFooterViewDelegate <NSObject>
...
@interface MKCLMqttServerConfigFooterView : UIView

@property (nonatomic, strong)MKCLMqttServerConfigFooterViewModel *dataModel;

@property (nonatomic, weak)id <MKCLMqttServerConfigFooterViewDelegate>delegate;
