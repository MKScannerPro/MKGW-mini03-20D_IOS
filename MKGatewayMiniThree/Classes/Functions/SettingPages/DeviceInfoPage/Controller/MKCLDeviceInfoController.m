...
@interface MKCLDeviceInfoController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKCLDeviceInfoModel *dataModel;

@end

@implementation MKCLDeviceInfoController

- (void)dealloc {
    NSLog(@"MKCLDeviceInfoController销毁");
}
...
- (void)loadSectionDatas {
    ...
    cellModel6.rightMsg = self.dataModel.masterFirmware;
    ...
    cellModel8.rightMsg = self.dataModel.slaveFirmware;
...
- (MKCLDeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCLDeviceInfoModel alloc] init];
    }
    return _dataModel;
}
