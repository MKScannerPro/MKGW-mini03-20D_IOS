...
@interface MKCLDeviceInfoModel : NSObject
...
@property (nonatomic, copy)NSString *masterFirmware;

@property (nonatomic, copy)NSString *wifiStaMac;

@property (nonatomic, copy)NSString *slaveFirmware;
