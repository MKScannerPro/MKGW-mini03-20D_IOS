...
@implementation MKCLAlertViewModel
@end

@interface MKCLAlertView ()
...
@implementation MKCLAlertView

- (void)dealloc {
    NSLog(@"MKCLAlertView销毁");
}
...
- (void)showWithModel:(MKCLAlertViewModel *)dataModel
    ...
    if (!dataModel || ![dataModel isKindOfClass:MKCLAlertViewModel.class]) {
        return;
    }
