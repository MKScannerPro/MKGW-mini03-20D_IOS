...
@interface MKCLImportServerController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MKCLImportServerController

- (void)dealloc {
    NSLog(@"MKCLImportServerController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.delegate respondsToSelector:@selector(cl_selectedServerParams:)]) {
        [self.delegate cl_selectedServerParams:model.leftMsg];
    }
