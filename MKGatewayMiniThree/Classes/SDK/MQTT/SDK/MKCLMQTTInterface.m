...
@implementation MKCLMQTTInterface
...
+ (void)cl_rebootDeviceWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                ...
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskRebootDeviceOperation
                                  sucBlock:sucBlock
...
+ (void)cl_configKeyResetType:(mk_cl_keyResetType)type
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskKeyResetTypeOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configNetworkStatusReportInterval:(NSInteger)interval
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigNetworkStatusReportIntervalOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configReconnectTimeout:(NSInteger)timeout
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigReconnectTimeoutOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configOTAWithFilePath:(NSString *)filePath
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigOTAHostOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configNTPServer:(BOOL)isOn
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigNTPServerOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configDeviceTimeZone:(NSInteger)timeZone
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigDeviceTimeZoneOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configCommunicationTimeout:(NSInteger)timeout
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigCommunicationTimeoutOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configIndicatorLightStatus:(id <cl_indicatorLightStatusProtocol>)protocol
    ...
    if (![protocol conformsToProtocol:@protocol(cl_indicatorLightStatusProtocol)]) {
        [self operationFailedBlockWithMsg:@"Params error" failedBlock:failedBlock];
        return;
    }
    NSDictionary *data = @{
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigIndicatorLightStatusOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_resetDeviceWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskResetDeviceOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configNpcOTAWithFilePath:(NSString *)filePath
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigNpcOTAHostOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_modifyWifiInfos:(id <mk_cl_mqttModifyWifiProtocol>)protocol
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskModifyWifiInfosOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_modifyNetworkInfos:(id <mk_cl_mqttModifyNetworkProtocol>)protocol
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskModifyNetworkInfoOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_modifyMqttInfos:(id <mk_cl_modifyMqttServerProtocol>)protocol
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskModifyMqttInfoOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_modifyMqttCerts:(id <mk_cl_modifyMqttServerCertsProtocol>)protocol
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskModifyMqttCertsOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configScanSwitchStatus:(BOOL)isOn
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigScanSwitchStatusOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configFilterRelationship:(mk_cl_filterRelationship)relationship
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigFilterRelationshipsOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configFilterByRSSI:(NSInteger)rssi
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigFilterByRSSIOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configFilterByMacAddress:(nonnull NSArray <NSString *>*)macList
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigFilterByMacAddressOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configFilterByADVName:(nonnull NSArray <NSString *>*)nameList
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigFilterByADVNameOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configFilterByBeacon:(BOOL)isOn
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigFilterByBeaconOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configFilterByUID:(BOOL)isOn
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigFilterByUIDOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configFilterByURL:(BOOL)isOn
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigFilterByUrlOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configFilterByTLM:(BOOL)isOn
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigFilterByTLMOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configFilterFilterBXPDeviceInfo:(BOOL)isOn
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigFilterBXPDeviceInfoOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configFilterBXPAcc:(BOOL)isOn
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigFilterBXPAccOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configFilterBXPTH:(BOOL)isOn
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigFilterBXPTHOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configFilterBXPButton:(id <mk_cl_BLEFilterBXPButtonProtocol>)protocol
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigFilterBXPButtonOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configFilterByTag:(BOOL)isOn
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigFilterByTagOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configFilterByPir:(id <mk_cl_BLEFilterPirProtocol>)protocol
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigFilterByPirOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configFilterByOtherDatas:(BOOL)isOn
    ...
    if (rawDataList.count == 1 && relationship != mk_cl_filterByOther_A) {
        [self operationFailedBlockWithMsg:@"Params error" failedBlock:failedBlock];
        return;
    }
    if (rawDataList.count == 2 && relationship != mk_cl_filterByOther_AB && relationship != mk_cl_filterByOther_AOrB) {
        [self operationFailedBlockWithMsg:@"Params error" failedBlock:failedBlock];
        return;
    }
    if (rawDataList.count == 3 && relationship != mk_cl_filterByOther_ABC && relationship != mk_cl_filterByOther_ABOrC && relationship != mk_cl_filterByOther_AOrBOrC) {
        [self operationFailedBlockWithMsg:@"Params error" failedBlock:failedBlock];
        return;
    }
    NSMutableArray *dicList = [NSMutableArray array];
    for (id <mk_cl_BLEFilterRawDataProtocol>protocol in rawDataList) {
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigFilterByOtherDatasOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configDuplicateDataFilter:(mk_cl_duplicateDataFilter)filter
    ...
    if (filter != mk_cl_duplicateDataFilter_none && (period < 1 || period > 86400)) {
        [self operationFailedBlockWithMsg:@"Params error" failedBlock:failedBlock];
        return;
    }
    NSDictionary *data = @{
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigDuplicateDataFilterOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configDataReportTimeout:(NSInteger)timeout
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigDataReportTimeoutOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configUploadDataOption:(id <cl_uploadDataOptionProtocol>)protocol
    ...
    if (![protocol conformsToProtocol:@protocol(cl_uploadDataOptionProtocol)]) {
        [self operationFailedBlockWithMsg:@"Params error" failedBlock:failedBlock];
        return;
    }
    NSDictionary *data = @{
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigUploadDataOptionOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_connectBXPButtonWithPassword:(NSString *)password
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConnectBXPButtonWithMacOperation
                                   timeout:50
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_disconnectNormalBleDeviceWithBleMac:(NSString *)bleMacAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskDisconnectNormalBleDeviceWithMacOperation
                                   timeout:50
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_startBXPButtonDfuWithFirmwareUrl:(NSString *)firmwareUrl
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskStartBXPButtonDfuWithMacOperation
                                   timeout:50
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_connectNormalBleDeviceWithBleMac:(NSString *)bleMacAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConnectNormalBleDeviceWithMacOperation
                                   timeout:50
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readKeyResetTypeWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadKeyResetTypeOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readDeviceInfoWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadDeviceInfoOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readNetworkStatusReportIntervalWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadNetworkStatusReportIntervalOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readNetworkReconnectTimeoutWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadNetworkReconnectTimeoutOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readNTPServerWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadNTPServerOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readDeviceUTCTimeWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadDeviceUTCTimeOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readCommunicateTimeoutWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadCommunicateTimeoutOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readIndicatorLightStatusWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadIndicatorLightStatusOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readOtaStatusWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadOtaStatusOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readWifiInfosWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadWifiInfosOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readNetworkInfosWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadNetworkInfosOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readMQTTParamsWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadMQTTParamsOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readScanSwitchStatusWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadScanSwitchStatusOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readFilterRelationshipWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadFilterRelationshipsOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readFilterByRSSIWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadFilterByRSSIOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readFilterByMacWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadFilterByMacOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readFilterByADVNameWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadFilterADVNameRSSIOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readFilterByRawDataStatusWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadFilterByRawDataStatusOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readFilterByBeaconWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadFilterByBeaconOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readFilterByUIDWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadFilterByUIDOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readFilterByUrlWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadFilterByUrlOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readFilterByTLMWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadFilterByTLMOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readFilterBXPDeviceInfoStatusWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadFilterBXPDeviceInfoStatusOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readFilterBXPAccStatusWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadFilterBXPAccStatusOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readFilterBXPTHStatusWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadFilterBXPTHStatusOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readFilterBXPButtonWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadFilterBXPButtonOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readFilterBXPTagWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadFilterBXPTagOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readFilterByPirWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadFilterByPirOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readFilterOtherDatasWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadFilterOtherDatasOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readDuplicateDataFilterDatasWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadDuplicateDataFilterDatasOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readDataReportTimeoutWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadDataReportTimeoutOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readUploadDataOptionWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadUploadDataOptionOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readBXPButtonConnectedDeviceInfoWithBleMacAddress:(NSString *)bleMacAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadBXPButtonConnectedDeviceInfoOperation
                                   timeout:50
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readBXPButtonConnectedStatusWithBleMacAddress:(NSString *)bleMacAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadBXPButtonStatusOperation
                                   timeout:50
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_dismissBXPButtonAlarmStatusWithBleMacAddress:(NSString *)bleMacAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskDismissAlarmStatusOperation
                                   timeout:50
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configDeviceLedReminderWithBleMac:(NSString *)bleMacAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigDeviceLedReminderOperation
                                   timeout:50
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configDeviceBuzzerReminderWithBleMac:(NSString *)bleMacAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigDeviceBuzzerReminderOperation
                                   timeout:50
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readGatewayBleConnectStatusWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadGatewayBleConnectStatusOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readNormalConnectedDeviceInfoWithBleMacAddress:(NSString *)bleMacAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadNormalConnectedDeviceInfoOperation
                                   timeout:50
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_notifyCharacteristic:(BOOL)notify
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskNotifyCharacteristicOperation
                                   timeout:50
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readCharacteristicValueWithBleMacAddress:(NSString *)bleMacAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadCharacteristicValueOperation
                                   timeout:50
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_writeValueToDeviceWithBleMacAddress:(NSString *)bleMacAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskWriteCharacteristicValueOperation
                                   timeout:50
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readAdvertiseBeaconParamsWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadAdvertiseBeaconParamsOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configAdvertiseBeaconParams:(id <cl_advertiseBeaconProtocol>)protocol
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigAdvertiseBeaconParamsOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_readFilterByPhyWithMacAddress:(NSString *)macAddress
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskReadFilterByPhyOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (void)cl_configFilterByPhy:(mk_cl_PHYMode)phy
    ...
    [[MKCLMQTTDataManager shared] sendData:data
                                     topic:topic
                                macAddress:macAddress
                                    taskID:mk_cl_server_taskConfigFilterByPhyOperation
                                  sucBlock:sucBlock
                               failedBlock:failedBlock];
}
...
+ (BOOL)isConfirmRawFilterProtocol:(id <mk_cl_BLEFilterRawDataProtocol>)protocol {
    if (![protocol conformsToProtocol:@protocol(mk_cl_BLEFilterRawDataProtocol)]) {
        return NO;
    }
...
+ (BOOL)isConfirmPirPresenceProtocol:(id <mk_cl_BLEFilterPirProtocol>)protocol {
    if (![protocol conformsToProtocol:@protocol(mk_cl_BLEFilterPirProtocol)]) {
        return NO;
    }
...
+ (BOOL)isConfirmWifiProtocol:(id <mk_cl_mqttModifyWifiProtocol>)protocol {
    if (![protocol conformsToProtocol:@protocol(mk_cl_mqttModifyWifiProtocol)]) {
        return NO;
    }
    if (!ValidStr(protocol.ssid) || protocol.ssid.length > 32) {
        return NO;
    }
    if (protocol.country < 0 || protocol.country > 21) {
        return NO;
    }
    return YES;
}

+ (BOOL)isConfirmNetworkProtocol:(id <mk_cl_mqttModifyNetworkProtocol>)protocol {
    if (![protocol conformsToProtocol:@protocol(mk_cl_mqttModifyNetworkProtocol)]) {
        return NO;
    }
    if (protocol.dhcp) {
        return YES;
...
+ (BOOL)isConfirmMqttServerProtocol:(id <mk_cl_modifyMqttServerProtocol>)protocol {
    if (![protocol conformsToProtocol:@protocol(mk_cl_modifyMqttServerProtocol)]) {
        return NO;
    }
...
+ (BOOL)isConfirmMqttServerCertsProtocol:(id <mk_cl_modifyMqttServerCertsProtocol>)protocol {
    if (![protocol conformsToProtocol:@protocol(mk_cl_modifyMqttServerCertsProtocol)]) {
        return NO;
    }
...
+ (BOOL)isConfirmAdvBeaconProtocol:(id <cl_advertiseBeaconProtocol>)protocol {
    if (![protocol conformsToProtocol:@protocol(cl_advertiseBeaconProtocol)]) {
        return NO;
    }
