...
static NSString *const fileName = @"MKCLServerParams.txt";

@interface MKCLServerParamsModel ()
...
@implementation MKCLServerParamsModel
...
- (BOOL)checkServerDataProtocol:(id <MKCLServerParamsProtocol>)protocol {
