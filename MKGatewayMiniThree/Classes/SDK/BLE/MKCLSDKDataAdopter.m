...
@implementation MKCLSDKDataAdopter

+ (NSString *)fetchConnectModeString:(mk_cl_connectMode)mode {
    switch (mode) {
        case mk_cl_connectMode_TCP:
            return @"00";
        case mk_cl_connectMode_CASignedServerCertificate:
            return @"01";
        case mk_cl_connectMode_CACertificate:
            return @"02";
        case mk_cl_connectMode_SelfSignedCertificates:
            return @"03";
    }
}
...
+ (NSString *)fetchMqttServerQosMode:(mk_cl_mqttServerQosMode)mode {
    switch (mode) {
        case mk_cl_mqttQosLevelAtMostOnce:
            return @"00";
        case mk_cl_mqttQosLevelAtLeastOnce:
            return @"01";
        case mk_cl_mqttQosLevelExactlyOnce:
            return @"02";
    }
}
