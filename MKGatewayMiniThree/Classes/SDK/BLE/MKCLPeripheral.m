...
@interface MKCLPeripheral ()

@property (nonatomic, strong)CBPeripheral *peripheral;

@end

@implementation MKCLPeripheral
...
- (void)updateCharacterWithService:(CBService *)service {
    [self.peripheral cl_updateCharacterWithService:service];
}

- (void)updateCurrentNotifySuccess:(CBCharacteristic *)characteristic {
    [self.peripheral cl_updateCurrentNotifySuccess:characteristic];
}

- (BOOL)connectSuccess {
    return [self.peripheral cl_connectSuccess];
}

- (void)setNil {
    [self.peripheral cl_setNil];
}
