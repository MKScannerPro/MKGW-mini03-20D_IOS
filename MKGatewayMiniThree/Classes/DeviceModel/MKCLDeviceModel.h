...
typedef NS_ENUM(NSInteger, MKCLDeviceModelState) {
    MKCLDeviceModelStateOffline,
    MKCLDeviceModelStateOnline,
};

//当设备离线的时候发出通知
extern NSString *const MKCLDeviceModelOfflineNotification;

@protocol MKCLDeviceModelDelegate <NSObject>
...
@interface MKCLDeviceModel : NSObject<MKCLDeviceModeManagerDataProtocol>
...
/**
 设备的状态，离线、在线
 */
@property (nonatomic, assign)MKCLDeviceModelState onLineState;

#pragma mark - 业务流程相关

@property (nonatomic, weak)id <MKCLDeviceModelDelegate>delegate;
