...
static MKCLUserLoginManager *loginManager = nil;
static dispatch_once_t onceToken;

@interface MKCLUserLoginManager ()
...
+ (MKCLUserLoginManager *)shared {
    dispatch_once(&onceToken, ^{
        if (!loginManager) {
            loginManager = [MKCLUserLoginManager new];
        }
    });
    return loginManager;
}
